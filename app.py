...
st.markdown(f"""
    ...
    /* Regular buttons - FMN Green border */
    .stButton > button {{
    ...
    /* Success boxes - keep light green background */
    .element-container div[data-testid="stMarkdownContainer"] > div[style*="background-color: rgb(0, 104, 201)"] {{
        background-color: #d4edda !important;
        border-left: 4px solid {FMN_COLORS['primary_green']} !important;
    }}
    
    /* Warning boxes - keep light orange background */
    div[data-baseweb="notification"][kind="warning"] {{
        background-color: #fff3cd !important;
        border-left: 4px solid {FMN_COLORS['primary_orange']} !important;
    }}
    
    /* Info boxes - keep light blue background */
